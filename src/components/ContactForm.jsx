...
const ContactForm = () => {
  ...
  return (
    <div id="CONTACTO" className="pt-10 bg-contact bg-cover">
      <div className="max-w-md w-full mx-auto mb-10 p-6 bg-black/50 border-[2px] border-white rounded-lg shadow-lg shadow-neon-cian">
        <h2 className="text-7xl text-bold mb-10 text-center text-personal-gray font-bebas-neue tracking-widest">
          CONTACTAME
        </h2>
        ...
        <form className="font-roboto tracking-widest" action="https://getform.io/f/pbmqkqqb" method="POST">
          <div className="mb-4">
          ...
          <div>
            <button
              onClick={handleClick}
              className="bg-personal-gray border-[2px] border-personal-gray text-black font-semibold px-4 py-2 rounded-lg hover:bg-transparent hover:text-personal-gray hover:border-personal-gray hover:shadow-md hover:shadow-neon-cian focus:ring focus:ring-neon-cian"
              type="submit"
            >
              ENVIAR
            </button>
