import { IoLogoHtml5, IoLogoCss3, IoLogoSass,IoLogoJavascript, IoLogoReact, IoLogoAngular, IoLogoNodejs, IoLogoPython, IoLogoWordpress, IoLogoGithub, IoLogoFirebase } from "react-icons/io5";
...
const Skills = () => {
  return (
    <div className="py-10 px-12 text-gray-500 bg-black">
      <h1 className="text-5xl text-personal-gray text-bold mb-12 text-center">SKILLS</h1>
      <div className="grid lg:grid-cols-6 grid-cols-2 gap-12">
        <div className="bg-personal-gray border-[2px] border-personal-gray p-[10px] rounded-xl flex flex-col items-center justify-center hover:border-[2px] hover:border-neon-cian hover:bg-transparent hover:text-neon-cian duration-500 ease-in-out">
        ...
        <div className="bg-personal-gray border-[2px] border-personal-gray p-[10px] rounded-xl flex flex-col items-center justify-center hover:border-[2px] hover:border-neon-cian hover:bg-transparent hover:text-neon-cian duration-500 ease-in-out">
          <IoLogoAngular className="text-[40px] my-2 text-center" />
          <h2 className="text-[17px] font-bold my-2">ANGULAR</h2>
        </div>
        <div className="bg-personal-gray border-[2px] border-personal-gray p-[10px] rounded-xl flex flex-col items-center justify-center hover:border-[2px] hover:border-neon-cian hover:bg-transparent hover:text-neon-cian duration-500 ease-in-out">
        ...
        <div className="bg-personal-gray border-[2px] border-personal-gray p-[10px] rounded-xl flex flex-col items-center justify-center hover:border-[2px] hover:border-neon-cian hover:bg-transparent hover:text-neon-cian duration-500 ease-in-out">
          <IoLogoPython className="text-[40px] my-2 text-center" />
          <h2 className="text-[17px] font-bold my-2">PYTHON</h2>
        </div>
        <div className="bg-personal-gray border-[2px] border-personal-gray p-[10px] rounded-xl flex flex-col items-center justify-center hover:border-[2px] hover:border-neon-cian hover:bg-transparent hover:text-neon-cian duration-500 ease-in-out">
          <BiLogoDjango className="text-[40px] my-2 text-center" />
          <h2 className="text-[17px] font-bold my-2">DJANGO</h2>
        </div>
        <div className="bg-personal-gray border-[2px] border-personal-gray p-[10px] rounded-xl flex flex-col items-center justify-center hover:border-[2px] hover:border-neon-cian hover:bg-transparent hover:text-neon-cian duration-500 ease-in-out">
